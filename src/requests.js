...
export const GITHUB_BASE_URL = "https://github.com/shahishree03";
export const GITHUB_AVATAR_URL = "https://avatars.githubusercontent.com/u/65016292?s=400&u=4098c108083a94159e4333bfc6dbe5e8fd04a985&v=4";
const GITHUB_ASSETS_BASE_URL = "https://cdn.jsdelivr.net/gh/chrizeone/movies";
export const LANG = "en-US";
export const REGION = "US";
export const BASE_IMG_URL = "https://image.tmdb.org/t/p/original";
export const FALLBACK_IMG_URL = `https://cdn.jsdelivr.net/gh/chrizeone/movies@master/radhekrishna.png`;
...
export const SIGNIN_BGIMG_URL = `${GITHUB_ASSETS_BASE_URL}/Fakeflix_auth_bg.png`;
